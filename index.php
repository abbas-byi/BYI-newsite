...
<div class="page-wrapper dark-layout">
	...
	<section class="banner-section">
		...
		<div class="auto-container">
			<div class="content-box">
				<span class="sub-title wow fadeInUp" data-wow-delay="1500ms">providing innovative <br>Website solution for you</span>
				...
				<a href="page-about.html" class="circle-text wow zoomIn" data-wow-delay="2000ms">
			...
			<div class="outer-box">
				<div class="row">
					...
					<div class="service-block-four col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
						<div class="inner-box">
							<figure class="image"><img src="images/resource/service4-1.jpg" alt=""></figure>
							<span class="letter">W</span>
							<div class="content">
								<span class="letter">W</span>
								<h4 class="title"><a href="page-service-details.html">Website <br>development</a></h4>
								<div class="text">We build beautiful, user-friendly websites that help you grow your business.</div>
								<a href="page-service-details.html" class="read-more"><i class="icon-arrow-down"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="service-block-four col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
						<div class="inner-box">
							<figure class="image"><img src="images/resource/service4-2.jpg" alt=""></figure>
							<span class="letter">G</span>
							<div class="content">
								<span class="letter">G</span>
								<h4 class="title"><a href="page-service-details.html">Graphic <br>designing</a></h4>
								<div class="text"> We create stunning graphics that help you communicate your message effectively.</div>
								<a href="page-service-details.html" class="read-more"><i class="icon-arrow-down"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="service-block-four col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
						<div class="inner-box">
							<figure class="image"><img src="images/resource/service4-3.jpg" alt=""></figure>
							<span class="letter">M</span>
							<div class="content">
								<span class="letter">M</span>
								<h4 class="title"><a href="page-service-details.html">Mobile <br>application</a></h4>
								<div class="text"> We develop innovative mobile apps that help you reach your target audience.</div>
								<a href="page-service-details.html" class="read-more"><i class="icon-arrow-down"></i></a>
							</div>
						</div>
					</div>
					...
					<!-- Service Block four -->
					<div class="service-block-four col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="900ms">
						<div class="inner-box">
							<figure class="image"><img src="images/resource/service4-4.jpg" alt=""></figure>
							<span class="letter">D</span>
							<div class="content">
								<span class="letter">D</span>
								<h4 class="title"><a href="page-service-details.html">Designing <br> Branding</a></h4>
								<div class="text">We help you grow your business online through search engine optimization, social media marketing, and other digital marketing channels.</div>
								<a href="page-service-details.html" class="read-more"><i class="icon-arrow-down"></i></a>
							</div>
						</div>
					</div>
			...
			<div class="fact-counter">
				<div class="row">
					...
					<div class="counter-block col-lg-3 col-md-6 col-sm-12 wow zoomIn">
						<div class="inner">
							<div class="count-box"><span class="count-text" data-speed="3000" data-stop="57">0</span></div>
					...
					<div class="counter-block col-lg-3 col-md-6 col-sm-12 wow zoomIn" data-wow-delay="600ms">
						<div class="inner">
							<div class="count-box"><span class="count-text" data-speed="3000" data-stop="612">0</span></div>
	...
	<section class="testimonial-section">
		...
		<div class="marquee">
			<div class="marquee-group">
				<div class="text">Testimonials / <span class="color1">Testimonials</span> / Testimonials /&nbsp;</div>
			</div>
			<div aria-hidden="true" class="marquee-group">
				<div class="text"><span class="color1">Testimonials </span> / Testimonials / <span class="color1"> Testimonials </span> /&nbsp;</div>
			</div>
		</div>

		<div class="auto-container">
			<div class="carousel-outer">
				<div class="bg bg-thumbs wow fadeIn" style="background-image: url(images/resource/testi-thumbs.png)"></div>
				<div class="testimonial-carousel owl-carousel owl-theme">
					<!-- Testimonial Block -->
					<div class="testimonial-block">
						<div class="inner-box">
							<span class="icon fal fa-quote-left"></span>
							<div class="text">uild Your Innovation transformed our business with their exceptional IT solutions. Their team's expertise and commitment to excellence were evident throughout the project. They delivered a robust software solution that streamlined our operations and helped us achieve significant cost savings. We highly recommend Build Your Innovation for their professionalism, reliability, and innovative approach.</div>
							<div class="info-box">
								<h5 class="name">Mike Hardson </h5>
								<span class="designation">CEO Birla Enterprises, Mumbai</span>
							</div>
						</div>
					</div>
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12 wow fadeInRight" data-wow-delay="600ms">
					<div class="inner-column">
						...
						<ul class="features-list">
							<li><a href="page-about.html">Branding</a></li>
							<li><a href="page-about.html">Development</a></li>
							<li><a href="page-about.html">Thinking</a></li>
							<li><a href="page-about.html">Execution</a></li>
						</ul>
					</div>
				</div>
...
<!-- Mirrored from kodesolution.com/html/2023/crotive-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 14:07:21 GMT -->
</html>
